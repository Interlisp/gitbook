...
* (1991) [Sun User Guide](https://interlisp.org/docs/SunUserGuide.pdf) ([HTML](https://interlisp.org/SunUserGuide.html))
* (1992) [Medley for the Novice](https://interlisp.org/docs/Medley-Primer.pdf) ([HTML](https://interlisp.org/Primer.html))
* (1993) [Interlisp Reference Manual](https://Interlisp.org/docs/IRM.pdf)  ([HTML](https://Interlisp.org/IRM.html)) 
